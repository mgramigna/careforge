...
export default function Privacy() {
  return (
    <div className="p-8">
      <div className="pt-2 text-center text-2xl font-bold">Privacy Policy</div>
      <div className="text-center italic">Last updated: December 21, 2023</div>
      <div className="pt-2">
        <p>
        ...
        <div className="py-2 text-xl font-bold">Collecting and Using Your Personal Data</div>
        <div className="pb-2 text-lg font-bold">Types of Data Collected</div>
        ...
        <div className="pt-2 font-bold">Tracking Technologies and Cookies</div>
        <p>
        ...
        <p>
          ...
          cookies on{' '}
          <Link href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies">
        ...
        <div className="text-lg font-bold">Use of Your Personal Data</div>
        ...
        <br />
        <div className="text-lg font-bold">Retention of Your Personal Data</div>
        <p>
        ...
        <br />
        <div className="text-lg font-bold">Transfer of Your Personal Data</div>
        <p>
        ...
        <br />
        <div className="text-lg font-bold">Disclosure of Your Personal Data</div>
        ...
        <br />
        <div className="text-lg font-bold">Security of Your Personal Data</div>
        <p>
        ...
        <br />
        <div className="text-xl font-bold">Links to Other Websites</div>
        <p>
        ...
        <br />
        <div className="text-xl font-bold">Changes to this Privacy Policy</div>
        <p>
        ...
        <p>
          If you have any questions about this Privacy Policy, You can contact us: matthewgramigna
          at gmail dot com
        </p>
      </div>
    </div>
